...
- **I1 / #234 — independent review in progress.** Branch `refactor/i1-iptv-stage-widgets`, reviewed-head candidate `0c65aece6806568c5a808219e2adefcbde33a6f0`. Exact owned files: `lib/widgets/iptv/iptv_results_view.dart`; `lib/widgets/iptv/stage/iptv_rail_info.dart`; `lib/widgets/iptv/stage/iptv_stage_chip.dart`; `lib/widgets/iptv/stage/iptv_stage_floor.dart`; `test/iptv_stage_widgets_origin_pin_test.dart`; `test/theme/shape_manifest_test.dart`.
- **T3 / #238 — queued.** Branch `refactor/t3-playback-candidate-ranking`, reviewed-head candidate `2c481e96d4ac5a84479935b9c40bc9453288e35f`. Exact owned files: `CODEMAP.md`; `lib/services/torrent_playback/playback_candidate_ranking.dart`; `lib/services/torrent_playback/playback_source_search.dart`; `lib/services/torrent_playback_service.dart`; `test/playback_candidate_ranking_origin_pin_test.dart`.
...
- **I2 / #239 — blocked on parent #234.** Branch `refactor/i2-iptv-preview-stage`, reviewed-head candidate `c1684b0c43ae0114620bfce63463f2d7a3323191`. Exact owned files: `lib/widgets/iptv/iptv_results_view.dart`; `lib/widgets/iptv/stage/iptv_cockpit_stage.dart`; `lib/widgets/iptv/stage/iptv_preview_rail.dart`; `lib/widgets/iptv/stage/iptv_preview_stage.dart`; `lib/widgets/iptv/stage/iptv_stage_state.dart`; `test/iptv_preview_stage_origin_pin_test.dart`; `test/theme/shape_manifest_test.dart`.
