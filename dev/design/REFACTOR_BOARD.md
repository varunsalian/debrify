...
- **D1 / #235 — queued.** Branch `refactor/d1-merged-detail-widgets`, reviewed-head candidate `44dbca9acd2332ccb1ac547279887cc2d5c22dbe`. Exact owned files: `lib/screens/merged_series_detail_screen.dart`; `lib/widgets/detail/detail_action_buttons.dart`; `lib/widgets/detail/detail_focus_chrome.dart`; `lib/widgets/detail/detail_rail_cards.dart`; `lib/widgets/detail/detail_tracker_sheets.dart`; `test/merged_detail_widgets_origin_pin_test.dart`.
- **I1 / #234 — queued.** Branch `refactor/i1-iptv-stage-widgets`, reviewed-head candidate `0c65aece6806568c5a808219e2adefcbde33a6f0`. Exact owned files: `lib/widgets/iptv/iptv_results_view.dart`; `lib/widgets/iptv/stage/iptv_rail_info.dart`; `lib/widgets/iptv/stage/iptv_stage_chip.dart`; `lib/widgets/iptv/stage/iptv_stage_floor.dart`; `test/iptv_stage_widgets_origin_pin_test.dart`; `test/theme/shape_manifest_test.dart`.
...
- **D2 / #237 — blocked on parent #235.** Branch `refactor/d2-merged-detail-tracker-status`, reviewed-head candidate `fc8ef5eb2f78d8c90a4828e1306432e75c1b0aa0`. Exact owned files: `lib/screens/merged_detail/detail_tracker_controller.dart`; `lib/screens/merged_detail/detail_trailer_controller.dart`; `lib/screens/merged_series_detail_screen.dart`; `test/merged_detail_tracker_status_origin_pin_test.dart`.
