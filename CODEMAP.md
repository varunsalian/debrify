...
## Players
- Discovered series IMDb/poster persistence: `services/playback/playlist_metadata_persistence.dart`
  (launch-provider identifiers; current `StorageService` profile ownership).
