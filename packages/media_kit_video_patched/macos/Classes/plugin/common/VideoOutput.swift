...
public class VideoOutput: NSObject {
  ...
  /// Runs after prior init/render work, and acknowledges only after the render
  /// context has been freed and the platform texture has been unregistered.
