...
class CacheManager implements BaseCacheManager {
  ...
  Future<File> putFile(
    ...
    try {
      ...
      final file =
          await _config.fileSystem.createFile(cacheObject.relativePath);
      await file.writeAsBytes(fileBytes);
      await _store.putFile(cacheObject);
      return file;
    } finally {
      _store.endFileOperation(key);
    }
  }
  ...
  Future<File> putFileStream(
    ...
    try {
      ...
      await _store.putFile(cacheObject.copyWith(length: await file.length()));
      return file;
    } finally {
      _store.endFileOperation(key);
    }
