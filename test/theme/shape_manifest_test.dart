...
const Map<String, int> kShapeResidue = {
  ...
  'lib/screens/search/hero_takeover_info.dart': 0,
...
void main() {
  ...
  test('Home takeover owner remains swept with its moved token', () {
    const path = 'lib/screens/search/hero_takeover_info.dart';
    expect(kShapeResidue[path], 0);
    expect('app.shape.br(4)'.allMatches(File(path).readAsStringSync()), hasLength(1));
  });
