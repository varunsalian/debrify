...
///
/// `dev/design/mockups/apple_look_mockup/index.html` is the specification and it is drawn at
...
void main() {
  ...
  group('the mock and the code agree', () {
    ...
    // Dart implements.
    final mock = File('dev/design/mockups/apple_look_mockup/index.src.html');

    test('the mock is present — it IS the spec', () {
      expect(mock.existsSync(), isTrue,
          reason:
              'dev/design/mockups/apple_look_mockup/index.src.html is the source of truth');
    });
