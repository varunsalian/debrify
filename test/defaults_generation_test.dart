...
void main() {
  ...
  group('defaults generation (update-aware flagship look)', () {
    ...
    test(
      'an explicit Classic pick (post-pinning) is fully preserved',
      () async {
    ...
    test(
      'generation 3: an install on the Spotlight Look adopts spotlight',
      () async {
    ...
    test(
      'generation 3: a Custom mix that kept the Spotlight theme adopts it',
      () async {
    ...
    test(
      'generation 3: an explicitly written value survives untouched',
      () async {
