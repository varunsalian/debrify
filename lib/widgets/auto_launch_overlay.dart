...
class AutoLaunchOverlay extends StatefulWidget {
  ...
  /// Escape-hatch hint, e.g. "Press BACK to cancel". Null hides the line.
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  // The escape hatch. The original overlay had none, which is
                  // the difference between a feature and a device the user
                  // can't get out of: a startup channel that hangs (dead
                  // provider, cold 50k catalog) would otherwise hold the screen
                  // for the full 30s timeout with no way to intervene.
