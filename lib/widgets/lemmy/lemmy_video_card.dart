...
/// Card widget for displaying a Lemmy video post
class LemmyVideoCard extends StatefulWidget {
  final LemmyVideoPost post;
  final VoidCallback onTap;
  final VoidCallback? onDownload;
  final FocusNode? focusNode;

  const LemmyVideoCard({
    super.key,
    required this.post,
    required this.onTap,
    this.onDownload,
  ...
  @override
  State<LemmyVideoCard> createState() => _LemmyVideoCardState();
}

class _LemmyVideoCardState extends State<LemmyVideoCard> {
