...
class ProfileCreationService {
  ...
  static const Set<String> copyablePreferenceKeys = <String>{
    ...
    'spotlight_focus_details',
    'sources_use_addon_text',
    'sources_show_addon_logos',
    'home_cw_hold_to_quick_play',
    'home_cw_merge_local',
    'home_cw_merge_trakt',
    'home_cw_merge_simkl',
    'home_cw_merge_mdblist',
    'tv_sidebar_style',
  ...
  Future<UserProfile> createStaged({
    ...
    try {
      if (copyDefaultsFromActive) {
        ...
        // These are deliberate new-profile choices, not legacy opt-outs.
        // Do not copy the general checkpoint: other migrations still apply.
        await target.setBool('sources_presentation_defaults_copied_v1', true);
      }
      await actor.validate(registry);
      return staged;
    } catch (_) {
