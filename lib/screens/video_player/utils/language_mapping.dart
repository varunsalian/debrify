...
class LanguageMapper {
  ...
  static const Map<String, Set<String>> _languageVariants = {
    ...
    'hr': {'hr', 'hrv', 'scr', 'croatian', 'hrvatski', 'hr-hr'},
    'sr': {'sr', 'srp', 'scc', 'serbian', 'српски', 'srpski', 'sr-rs', 'sr-latn', 'sr-cyrl'},
    'bs': {'bs', 'bos', 'bosnian', 'bosanski', 'bs-ba'},
    'mk': {'mk', 'mkd', 'mac', 'macedonian', 'македонски', 'makedonski', 'mk-mk'},
