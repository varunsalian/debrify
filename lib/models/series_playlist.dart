...
class SeriesPlaylist {
  ...
  /// Read only this playlist's successful per-item metadata cache.
  String? cachedMovieImdbId(int index) => _movieImdbIds[index];

  /// Record a successful lookup before setting the first shared IMDb ID.
  void recordMovieMetadataSuccess(int index, String movieImdbId) {
    _movieImdbIds[index] = movieImdbId;
    imdbId ??= movieImdbId;
  }
