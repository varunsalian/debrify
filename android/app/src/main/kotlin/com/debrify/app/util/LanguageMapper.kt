...
object LanguageMapper {
    ...
    private val languageVariants = mapOf(
        ...
        "hr" to setOf("hr", "hrv", "scr", "croatian", "hrvatski", "hr-hr"),
        "sr" to setOf("sr", "srp", "scc", "serbian", "српски", "srpski", "sr-rs", "sr-latn", "sr-cyrl"),
        "bs" to setOf("bs", "bos", "bosnian", "bosanski", "bs-ba"),
        "mk" to setOf("mk", "mkd", "mac", "macedonian", "македонски", "makedonski", "mk-mk"),
